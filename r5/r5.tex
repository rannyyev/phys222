...
\begin{abstract}
\td{Write the abstract. Don't forget to comment on the results and conclusions of the experiment. Try to hit the 200-word mark. Consult the introduction for the necessary information.}
\end{abstract}

\section{Introduction}

\td{Take a glance at the introduction and fix mistakes if there are any. Maybe you can add some information.}
...
\td{There is a question asked in the lab manual: \enquote{How well do your values for the average focal length obtained in Part A and Part B agree 
with each other and the manufacturer's specifications? Discuss any discrepancies.} Try to expand on this question.}

The results of part B are shown in Table~\ref{tab:2}. The average focal length of the converging lens is $7.28$ cm with an error of $0.02$ cm. It is not within the limits of error of the actual focal length of the lens, which is $7.5$ cm. The average value of the focal length in part A and part do not agree with each other within the limits of error. This discrepancy may be due to the limitations of the experimental setup, such as the accuracy of the measurements and the alignment of the lenses. Since the sharpness of the image is subjective, different people may have different opinions about what constitutes a sharp image. This can lead to variations in the measurements of the object and image distances. 
...
\td{Write a comprehensive essay on the applications of lenses in various fields. Use at least two references because I believe we will not be granted any extra credit points if we do not use references. Please don't use non-scientific sources. Let's get a perfect score on this experiment.}
