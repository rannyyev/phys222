...
\td{Maybe add a section on extra credit since we messed up the quiz lmao. Add proper references and not some shady ahh website that popped the first in your google search or I'll beat the shit out of you. I also wonder if one can see the comments I leave here in GitHub commit history HAHAHA.}
