...
\td{I guess writing data is obsolete since git already saves data and time for every commit but we can still write it if you want so.}
...
\td{I guess reason for high similarity in last one was us being literally last person to submit it. so i guess no need to worry that much and its gonna be aight.}
...
\td{Everything looks lowk good. Idk you can improve or add some shit.}
\subsection*{Errors}
...
In conclusion, despite analog nature of experiment, sources of error and approximations experiment was succesfull and the calculated wavelengths were in good agreement with the literature values. The grating spectrometer is a powerful tool for measuring the wavelengths of spectral lines and can be used in a wide range of applications.

\section{Extra credit}

\td{They can see if they want to if you make this repo public in the future.}
