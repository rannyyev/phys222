...
After diffraction, the light waves interfere with each other, producing a pattern of bright and dark spots. The bright spots correspond to constructive interference or maximas, while the dark spots correspond to destructive interference or minimas. Maximas and minimas occur when \cite{Hecht_2017}:
