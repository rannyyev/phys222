...
\td{Also thought that a better way to write push comments is to use the \texttt{"April 28, 2024: Updated r6"} format. Lowkey looks better when there is a date indicated. Also you don't have to do everything I say. I also leave some comments for myself so I can remember what to do.}
