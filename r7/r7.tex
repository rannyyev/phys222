...
\item \textbf{Refractive index of air:} The refractive index of air was assumed to be $n = 1$ in the calculations. 
...
\td{Explain the discrepancies between the measured values and the accepted values.}

\subsection*{Conclusion}

\td{Conclude the experiment.}
