...
\begin{itemize}
  \item \textbf{Refractive index of the air:} The refractive index of the air was assumed to be $1$. In reality, it is approximately $1.0003$.
...
The discrepancies between the theoretical and experimental values are due to the errors mentioned above. As we can see from Figure~(\ref{fig:f2}), the theoretical and experimental values are in agreement with each other, but the experimental values are not as precise as the theoretical ones. The highest error between the theoretical and experimental values is around $25\%$, whereas the average error is around $15\%$.  
